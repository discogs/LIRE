...
public class SelfSimilaritiesFeature implements LocalFeature {
    ...
    public double getDistance(LireFeature f) {
        if (!(f instanceof SelfSimilaritiesFeature)) return -1;
        return MetricsUtils.distL2(feature, ((SelfSimilaritiesFeature) f).feature);
    }
    ...
    public String getFieldName() {
        return DocumentBuilder.FIELD_NAME_SELF_SIMILARITIES;
    }
